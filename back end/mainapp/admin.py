...
# I.1. Inline para las Imágenes del Producto (Máx 3)
...
# I.3. Inline para las Imágenes de Referencia del Pedido
...
class ProductoAdmin(admin.ModelAdmin):
    # I.6. list_display, list_filter, search_fields
...
# I.2. Gestión del Inventario de Insumos
...
class InsumoAdmin(admin.ModelAdmin):
    ...
    # Funcionalidad Extra: Acción para aumentar stock
...
# I.3. Administración Completa de Pedidos
...
class PedidoAdmin(admin.ModelAdmin):
    ...
    # I.5. Control del Estado de Pago (Check visual)
    ...
    # I.3. Validación de No Finalizar sin Pago Completo
    ...
    # I.6. Genera la URL de seguimiento visible en el Admin
