...
# 5. Control del Estado de Pago [I.5]
ESTADO_PAGO = (
    ('PENDIENTE', 'Pendiente'),
    ('PARCIAL', 'Parcial'),
    ('PAGADO', 'Pagado'),
...
class Pedido(models.Model):
    ...
    # Token único de seguimiento (Requisito I.6)
